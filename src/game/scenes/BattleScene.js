...
export default class BattleScene extends Phaser.Scene {
  ...
  drawCombatants() {
    ...
    this.playerSprite = this.add.sprite(240, 470, spriteKey(this.player.crewId), 0).setScale(7).setOrigin(0.5, 0.82).setDepth(10);
  ...
  switchCharacter(newMember, forced = false) {
    ...
    this.playerSprite.setTexture(spriteKey(newMember.crewId), 0);
