...
wildZones: [
  ...
  "ile-baratie": {
    ...
    terrain: [
      "ssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss",
      "ssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss",
      "ssssssssdffffffffffffffffffffffffffffffffffffffffffffffffffdssss",
      "ssssssssdffffffffffffffffffffffffffffffffffffffffffffffffffdssss",
      "ssssssssdffffffffffffffffffffffffffffffffffffffffffffffffffdssss",
      "sssssssdffffffffffffffffffffffffffffffffffffffffffffffffffffdsss",
      "sssssssdffffffffffffffffffffffffffffffffffffffffffffffffffffdsss",
      "sssssssdffffffffffffffffffffffffffffffffffffffffffffffffffffdsss",
      "sssssssdffffffffffffffffffffffffffffffffffffffffffffffffffffdsss",
      "sssssssdffffffffffffffffffffffffffffffffffffffffffffffffffffdsss",
      ...
      "sssssssdffffffffffffffffffffffffffffffffffffffffffffffffffffdsss",
      "sssssssdffffffffffffffffffffffffffffffffffffffffffffffffffffdsss",
      "sdddfffffffffffffffffffffffffffffffffffffffffffffffffffffffffdds",
      "sssssssdffffffffffffffffffffffffffffffffffffffffffffffffffffdsss",
      "sssssssdffffffffffffffffffffffffffffffffffffffffffffffffffffdsss",
      "sssssssdffffffffffffffffffffffffffffffffffffffffffffffffffffdsss",
      "sssssssdffffffffffffffffffffffffffffffffffffffffffffffffffffdsss",
    ...
    tavern: { x: 14, y: 22 },
    buildings: [
      { x: 14, y: 22, key: "taverne", scale: 0.42 },
    ],
    ...
    quests: [
      {
        ...
        description: "Parle à Zeff et découvre le restaurant flottant.",
        startFlag: "baratie_intro",
        completeFlag: "baratie_intro",
      },
      {
        id: "baratie-2",
        title: "Les problèmes en cuisine",
        description: "Parle à Sanji et aide les cuisiniers du Baratie.",
        startFlag: "baratie_kitchen",
        completeFlag: "baratie_kitchen",
      },
      {
        id: "baratie-3",
        title: "Les provisions",
        description: "Récupère les provisions perdues dans la cale.",
        startFlag: "baratie_provisions",
        completeFlag: "baratie_provisions",
      },
      {
        id: "baratie-4",
        title: "Des pirates approchent",
        description: "Zeff demande de défendre le Baratie.",
      ...
      },
      {
        ...
        description: "Affronte Pearl sur le pont du Baratie.",
        startFlag: "baratie_attack_started",
        completeFlag: "baratie_pearl_defeated",
      },
      {
        id: "baratie-6",
        title: "Gin",
        description: "Affronte Gin après la chute de Pearl.",
        startFlag: "baratie_pearl_defeated",
      ...
      },
      {
        ...
        description: "Affronte Sanji pour lui prouver ta valeur et recrute-le.",
    ...
    npcs: [
      {
        ...
        setFlag: "baratie_intro",
        dialogue: [
          "Bienvenue au Baratie. Ici, on sert tous ceux qui ont faim.",
          "Sanji travaille dans la cuisine. Va lui parler.",
      ...
      },
      {
        ...
        setFlag: "baratie_kitchen",
        dialogue: [
          "Je suis occupé. Si tu veux aider, commence par ne pas gêner les cuisiniers.",
          "Les provisions de la cale ont disparu. Retrouve-les et je t'écouterai.",
        ],
      },
      {
        id: "baratie-patty",
    ...
    chests: [
      ...
      { id: "baratie-chest-6", x: 52, y: 18, itemId: "potion", amount: 4, setFlag: "baratie_chasseurs_done" },
