...
export const ISLANDS = {
  ...
  "ile-depart": {
    ...
    wildZones: [
      { x1: 4, y1: 18, x2: 44, y2: 16, level: 1, encounterRate: 1, enemyPool: ["marineRecrue"] },
      { x1: 4, y1: 14, x2: 44, y2: 12, level: 2, encounterRate: 0.1, enemyPool: ["marineRecrue"] },
      { x1: 4, y1: 10, x2: 44, y2: 4, level: 3, encounterRate: 0.1, enemyPool: ["marineRecrue", "officierMarine"] },
      { x1: 4, y1: 10, x2: 44, y2: 4, level: 5, encounterRate: 0.07, enemyPool: ["marineRecrue", "officierMarine"] },
    ],
